...
import type { BaseLinkProps } from '../types/link.interface';

export const useLinkClasses = (props: BaseLinkProps): string => {
  ...
  return clsx(
    ...
    { 'w-full': fullWidth },
    {
      'shadow-[0_0_8px_rgba(0,0,0,0.05)]': shadowVariant === 'shadow',
    },
    colorVariant &&
      !disabled &&
      {
